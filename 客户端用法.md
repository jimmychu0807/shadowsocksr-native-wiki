...
如果你不是开发者, 就一普通苹果用户,你为了下载苹果应用商店的软件有一苹果账号,你也可以自己编译,让 SSRoT 运行在你自己的手机上. 看看 [这个教程](https://blog.csdn.net/foreverling_ling/article/details/56671458) 和 [SSRoT iOS 编译指南](https://github.com/ShadowsocksR-Live/iShadowsocksR#how-to-build-project) 就可以了, 据说可以使用7天, 过期后再编译一次覆盖原文件就好了.

> 貌似普通非开发者的苹果账号也可以打包 ipa 分发包了, 见[这个教程(教你如何不用开发者账号申请ios证书真机调试)](https://zhuanlan.zhihu.com/p/44203227), 不知真假. 国内不怕喝茶的朋友可以编译后联系我.
