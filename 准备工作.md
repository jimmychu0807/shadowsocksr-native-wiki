...
### 關於防火墻的問題
在安裝 Oracle 雲主機 Ubuntu 時，遇到個奇怪的問題：在已經於安全列表裏添加了“0.0.0.0/0  所有協議”的情況下，依然始終無法從外部訪問已安裝有 nginx 服務端軟件的 80 端口，發現得先裝上 firewall 組件再禁用它，就 OK 了，這脫褲子放屁的操作太奇葩，值得特別寫下來。 
```
